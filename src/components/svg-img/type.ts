export enum SvgIconEnum {
  ...
  FCR_MOBILE_PEN_CURVE_1SIZE = 'fcr_mobile_pen_curve_1size',
  FCR_MOBILE_PEN_CURVE_2SIZE = 'fcr_mobile_pen_curve_2size',
  FCR_MOBILE_PEN_CURVE_3SIZE = 'fcr_mobile_pen_curve_3size',
  FCR_MOBILE_PEN_CURVE_4SIZE = 'fcr_mobile_pen_curve_4size',
  FCR_MOBILE_PEN_LINE_1SIZE = 'fcr_mobile_pen_line_1size',
  FCR_MOBILE_PEN_LINE_2SIZE = 'fcr_mobile_pen_line_2size',
  FCR_MOBILE_PEN_LINE_3SIZE = 'fcr_mobile_pen_line_3size',
  FCR_MOBILE_PEN_LINE_4SIZE = 'fcr_mobile_pen_line_4size',
  ...
  FCR_STAR = 'fcr_star',
  FCR_STOP = 'fcr_stop',
  FCR_INVITE = 'fcr_invite',
  FCR_STUDENT_RASIEHAND = 'fcr_student_rasiehand',
  FCR_STUDENT_HELPHAND = 'fcr_student_helphand',
  ...
  FCR_MOBILE_WHITEBOARD_PED_CURVE = 'fcr_mobile_whiteboard_ped_curve',
  FCR_WHITEBOARD_PED_STRAIGHTLINE = 'fcr_whiteboard_ped_straightline',
  FCR_PENSIZE2 = 'fcr_pensize2',
  FCR_PENSIZE2_STRAIGHT = 'fcr_pensize2_straight',
  ...
  FCR_MOBILE_WHITEBOARD_PED_LINE = 'fcr_mobile_whiteboard_ped_line',
  FCR_MOBILE_COLOR_SIZE = 'fcr_mobile_color_size',
  FCR_MOBILE_CLOSE = 'fcr_mobile_close',
  FCR_MOBILE_ARROW_RIGHT = 'fcr_mobile_arrow_right',
